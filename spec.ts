...
export interface components {
  schemas: {
     ...
     */
    readonly ssh_key_fingerprint: string;
    /**
    ...
    app: {
      ...
      domains?: readonly components["schemas"]["apps_domain"][];
      /**
    ...
    database_layout_options: {
      ...
      layouts?: readonly components["schemas"]["database_layout_option"][];
    };
    ...
    database_cluster: {
      ...
      users?: (readonly components["schemas"]["database_user"][]) | null;
    ...
    connection_pools: {
      ...
      pools?: readonly components["schemas"]["connection_pool"][];
    };
    ...
    domain_record_a: components["schemas"]["domain_record"];
    domain_record_aaaa: components["schemas"]["domain_record"];
    domain_record_caa: components["schemas"]["domain_record"];
    domain_record_cname: components["schemas"]["domain_record"];
    domain_record_mx: components["schemas"]["domain_record"];
    domain_record_ns: components["schemas"]["domain_record"];
    domain_record_soa: components["schemas"]["domain_record"];
    domain_record_srv: components["schemas"]["domain_record"];
    domain_record_txt: components["schemas"]["domain_record"];
    /**
     * @deprecated
    ...
    kubernetes_node_pool_base: {
      ...
      nodes?: readonly components["schemas"]["node"][];
    };
    ...
    load_balancer_create: OneOf<[WithRequired<{
      /**
       * @description An array containing the IDs of the Droplets assigned to the load balancer.
       * @example [
       *   3164444,
    ...
    tags: {
       ...
       * }
       */
      resources?: components["schemas"]["tags_metadata"] & {
...
export interface operations {
  ...
  databases_create_kafka_topic: {
    ...
    requestBody?: {
      content: {
         ...
         * }
         */
        "application/json": WithRequired<components["schemas"]["kafka_topic_create"], "name">;
      };
    };
    responses: {
  ...
  firewalls_update: {
    ...
    requestBody?: {
      content: {
         ...
         * }
         */
        "application/json": WithRequired<components["schemas"]["firewall"], "name">;
      };
    };
    responses: {
  ...
  firewalls_add_rules: {
    ...
    requestBody?: {
      content: {
         ...
         * }
         */
        "application/json": components["schemas"]["firewall_rules"];
      };
    };
    responses: {
      204: components["responses"]["no_content"];
  ...
  uptime_create_alert: {
    ...
    requestBody: {
      content: {
        "application/json": WithRequired<components["schemas"]["alert"], "name" | "type" | "notifications" | "period">;
      };
    };
    responses: {
